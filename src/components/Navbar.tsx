...
import handleLogout from "./Authorization/Logout";

const Navbar: React.FC = () => {
  // State to hold the role value
  const [role, setRole] = useState<string>("");
  
  // Fetch the role value when the component mounts
  useEffect(() => {
  ...
  <a href="#" className="flex items-center whitespace-nowrap text-2xl font-black">
    ...
    <span className="text-black">Lala Rent</span>
  </a>
  ...
  <nav aria-label="Header Navigation" className="peer-checked:mt-8 peer-checked:max-h-56 flex max-h-0 w-full flex-col items-center justify-between overflow-hidden transition-all md:ml-24 md:max-h-full md:flex-row md:items-start">
    <ul className="flex flex-col items-center space-y-2 md:ml-auto md:flex-row md:space-y-0">
      <li className="text-gray-600 md:mr-12 hover:text-blue-600"><a href="/home">Home</a></li>
      {role === 'HOST' &&(<li className="text-gray-600 md:mr-12 hover:text-blue-600"><a href="/add-product">Add Property</a></li>)}
      {role === 'HOST' &&(<li className="text-gray-600 md:mr-12 hover:text-blue-600"><a href="/my-property">My Property</a></li>)}
      <li className="text-gray-600 md:mr-12 hover:text-blue-600"><a href="/my-order">My Orders</a></li>
      {role === 'HOST' &&(<li className="text-gray-600 md:mr-12 hover:text-blue-600"><a href="/booked">Booked</a></li>)}
      <li className="text-gray-600 md:mr-12 hover:text-blue-600"><a href="/setting">Profile</a></li>
